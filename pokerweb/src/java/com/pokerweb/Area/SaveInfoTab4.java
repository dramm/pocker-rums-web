 ...
 * @author vadim
 */
@WebServlet(name = "SaveInfoTab4", urlPatterns = {"/SaveInfoTab4"})
public class SaveInfoTab4 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean namesAdded = false;
            ...
            if(ValidationField.ValidConfPassword(CurrentPassword,ReceptCurrentPasswordEn) &&
                    ValidationField.ValidPassword(NewPassword) &&
                    ValidationField.ValidConfPassword(NewPassword,ConfNewPassword)){
                boolean res = DBM.UpdateCurrentUserTempInfoPassword(NewPassword,auth.getName());
                               if(res){
