 ...
 * @author vadim
 */
@WebServlet(name = "ConfirmEdit", urlPatterns = {"/ConfirmEdit"})
            ...
            BufferedReader reader = request.getReader();
                while ((line = reader.readLine()) != null)
                   ...
                   String token = jsonObject.getString("token");
                    ...
                    if(DBManager.GetInstance().ConfirmPrivatAreaToken(token))
                        js.append("ConfEdit","настройки сохранены");
                    else
                        js.append("ConfEdit","ошибка подтверждения");
